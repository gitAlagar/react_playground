...
// SimpleContactForm.jsx
// Single-file React component (default export) you can drop into a Create React App / Vite project.
// Uses Tailwind utility classes for styling. If you don't use Tailwind, replace className values with your own CSS.

export default function SimpleContactForm2() {
  ...
  const errors = Object.keys(validators).reduce((acc, key) => {
    const res = validators[key](form[key]);
    if (res !== true) acc[key] = res;
    return acc;
  }, {});
